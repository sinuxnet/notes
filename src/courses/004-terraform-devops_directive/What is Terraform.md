...
IaC tools allow you to define your entire cloud infrastructure as a set of config files which then the tool Terraform can go off and interact with the cloud provider API and provision and manage on our behalf.
